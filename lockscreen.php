  ...
  <div class="lockscreen-wrapper">
    ...
    <div class="lockscreen-item">
      <div class="lockscreen-image">
        ...
        <?php else : ?>
          <img src="<?php echo root_url();?>/assets/pprtnaa/img/nopeople.png">
        <?php endif; ?>
      </div>
    ...
    <div class="lockscreen-footer text-center">
      <div class="copyright" style="font-size:1.2rem;">Copyright © <?php echo date('Y'); ?> <a href="http://pabloretana.me">PPRTNAA</a></div>
    </div>
  </div>
