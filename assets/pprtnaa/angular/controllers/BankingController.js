        ...
        "buttons": [
            {
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        .css( 'font-size', '10pt' )
                        .append(
                            '<div><b><i>Developed & Maintained by: pabloretana.me</i></b></div>'
                        )
                        .prepend(
                            '<div class="dt-print-heading"><img class="logo" src="'+baseUrl+'/assets/pprtnaa/img/logo-favicons/1_logo.png"/><h2 class="title">'+window.store.name+'</h2><p><b><i>From</i> '+window.from +' <i>To</i> '+window.to+'</b><br>Printed on: '+window.formatDate(new Date())+'</p></div>'
        ...
        .then(function (willDelete) {
            if (willDelete) {
                ...
                .then(function (response) {
                    ...
                    window.swal("¡Exito!", "Currency successfully deleted!", "success");
                }, function (response) {
                    window.swal("¡Advertencia!", "unable to delete!", "error");
                });
            }
        });
    });
