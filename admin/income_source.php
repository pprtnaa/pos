...
// Add Script
$document->addScript('../assets/pprtnaa/angular/modals/IncomeSourceEditModal.js');
$document->addScript('../assets/pprtnaa/angular/modals/IncomeSourceDeleteModal.js');
$document->addScript('../assets/pprtnaa/angular/controllers/IncomeSourceController.js');
