...
window.$(document).ready(function ($) {
	...
	$(function() {
		$("#file").change(function() {
			...
			{
				$('#logo').attr('src',window.baseUrl+'/assets/pprtnaa/img/logo-favicons/nologo.png');
...
window.$(document).ready(function ($) {
	...
	$(function() {
		$("#faviconFile").change(function() {
			...
			if(!((imagefile==match[0]) || (imagefile==match[1]) || (imagefile==match[2])))
			{
				$('#favicon').attr('src',window.baseUrl+'/assets/pprtnaa/img/logo-favicons/nofavicon.png');
