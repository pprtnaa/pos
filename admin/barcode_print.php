...
// Add Style
$document->addStyle('../assets/pprtnaa/css/barcode.css', 'stylesheet', 'all');

// Add Script
$document->addScript('../assets/pprtnaa/angular/controllers/BarcodePrintController.js');
              ...
              if(isset($request->post['products'])):
                ...
                ?>
                  ...
                  <div class="text-center">
                    <div class="btn-group">
                      <button class="btn btn-warning" onClick="window.printContent('barcode-con', {title:'<?php echo trans('text_barcode_print');?>',screenSize:'fullScreen', cssLink:'<link type=\'text/css\' href=\'../assets/pprtnaa/css/barcode.css\' type=\'text/css\' rel=\'stylesheet\'>'});"><span class="fa fa-print"></span> <?php echo trans('button_print');?></button>
                    </div>
                  </div>
