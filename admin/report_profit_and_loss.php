...
// Add Script
$document->addScript('../assets/pprtnaa/angular/controllers/ReportLossController.js');
$document->addScript('../assets/pprtnaa/angular/controllers/ReportProfitController.js');
