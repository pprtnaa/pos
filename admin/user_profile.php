...
// Add ScriptS
$document->addScript('../assets/pprtnaa/angular/controllers/UserController.js');
$document->addScript('../assets/pprtnaa/angular/controllers/UserProfileController.js');
$document->addScript('../assets/pprtnaa/angular/controllers/ReportUserSellController.js');
$document->addScript('../assets/pprtnaa/angular/controllers/UserLoginLogController.js');
