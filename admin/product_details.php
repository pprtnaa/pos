...
// 	$document->addScript('../assets/pprtnaa/angular/controllers/ReportProductSellController.js');
// }
if (user_group_id() == 1 || has_permission('access', 'read_purchase_report')) {
	$document->addScript('../assets/pprtnaa/angular/controllers/ReportProductPurchaseController.js');
}
