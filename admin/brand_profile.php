...
// Add Script
$document->addScript('../assets/pprtnaa/angular/controllers/BrandProfileController.js');
if (user_group_id() == 1 || has_permission('access', 'read_sell_report')) {
  $document->addScript('../assets/pprtnaa/angular/controllers/ReportBrandSellController.js');
}
