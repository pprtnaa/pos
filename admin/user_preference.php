...
// Add Script
$document->addScript('../assets/pprtnaa/angular/controllers/SystemController.js');
				...
				<div class="box-body">
			        <div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<?php 
								$patterns = get_filenames(DIR_ASSET.'pprtnaa/img/pos/patterns'); 
								...
								<?php for ($i=0; $i < $total_pattern; $i++) : ?>
									<li class="<?php echo isset($preference['pos_pattern']) && $preference['pos_pattern'] == $patterns[$i] ? 'selected' : ''; ?>" data-name="<?php echo $patterns[$i]; ?>" title="<?php echo str_replace(array('.jpg','.jpeg', '.png','.gif','.svg'), '', $patterns[$i]); ?>">
										<img src="../assets/pprtnaa/img/pos/patterns/<?php echo $patterns[$i]; ?>">
									</li>
								<?php endfor; ?>
								</ul>
							</div>
