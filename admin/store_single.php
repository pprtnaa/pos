...
// Add Script
$document->addScript('../assets/pprtnaa/angular/controllers/StoreActionController.js');
$document->addScript('../assets/pprtnaa/js/upload.js');
				...
				<form id="uploadlogo" class="upload-form" action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-2 text-center">	            
							<div id="logo_preview">
								<?php if (store('logo')): ?>
									<img id="logo" src="../assets/pprtnaa/img/logo-favicons/<?php echo store('logo'); ?>">
								<?php else: ?>
									<img id="logo" src="../assets/pprtnaa/img/logo-favicons/nologo.png">
								<?php endif; ?>
							</div>
							<p>
								Max. 100 kb
						...
						<?php if (user_group_id() == 1 || has_permission('access', 'upload_logo')) : ?>
						    <div class="col-sm-4">	            
								<div class="upload-field" id="selectImage">
									...
									<img class="loader logo-loader" src="../assets/pprtnaa/img/loading.gif">
								</div>
						    </div>
						<?php endif; ?>
						...
						<div class="col-sm-2 text-center">	            
							<div id="favicon_preview">
								<?php if (store('favicon')): ?>
									<img id="favicon" src="../assets/pprtnaa/img/logo-favicons/<?php echo store('favicon'); ?>">
								<?php else: ?>
									<img id="favicon" src="../assets/pprtnaa/img/logo-favicons/nofavicon.png">
								<?php endif; ?>
							</div>
							<p>
								Max. 50 kb
						...
						<?php if (user_group_id() == 1 || has_permission('access', 'upload_favicon')) : ?>
							<div class="col-sm-4">	            
								<div class="upload-field" id="selectFavicon">
									...
									<img class="loader favicon-loader" src="../assets/pprtnaa/img/loading.gif">
								</div>
							</div>
						<?php endif; ?>
						<div class="clearfix"></div>
