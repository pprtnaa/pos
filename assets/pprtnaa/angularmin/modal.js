        ...
        var uibModalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                .then(function(response, status, headers, config) {
                   ...
                   window.swal("¡Advertencia!", "an unknown error occured!", "error");
                });
        ...
        var uibModalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                .then(function (response, status, headers, config) {
                    ...
                    window.swal("¡Advertencia!", response.data.errorMsg, "error").then(function() {
        ...
        var uibModalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                .then(function(response, status, headers, config) {
                   ...
                   window.swal("¡Advertencia!", "an error occured!", "error");
                });
                    ...
                    then(function(response) {
                        ...
                        if (window.getParameterByName("holding_id") || window.getParameterByName("qref")) {
                            ...
                            if (window.settings.after_sell_page == 'receipt_in_new_window') {
                                ...
                                window.toastr.success("ID: "+$scope.invoiceId, "¡Muy bien hecho!");
                        ...
                        if ($scope.customerMobileNumber && window.settings.invoice_auto_sms == '1') {
                            ...
                            then(function(response) {
                                window.toastr.success("SMS sent to the number: " + $scope.customerMobileNumber, "¡Muy bien hecho!");
                            }, function(response) {
                                window.swal("¡Advertencia!", response.data.errorMsg, "error");
                            });
                        }
