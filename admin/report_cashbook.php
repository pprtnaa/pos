...
// Add Script
$document->addScript('../assets/pprtnaa/angular/controllers/ReportIncomeDaywiseController.js');
$document->addScript('../assets/pprtnaa/angular/controllers/ReportExpenseDaywiseController.js');
    ...
    $("#btn-update-balance").on("click", function(e) {
      ...
      $.ajax({
        ...
        success: function(res) {
          window.swal("¡Muy bien hecho!", res.msg, "success")
          .then(function() {
