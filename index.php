...
<head>
  ...
  <?php if ($store->get('favicon')): ?>
      <link rel="shortcut icon" href="assets/pprtnaa/img/logo-favicons/<?php echo $store->get('favicon'); ?>">
  <?php else: ?>
  ...
  <?php if (DEMO || USECOMPILEDASSET) : ?>
    ...
    <!-- LOGIN COMBINED CSS -->
    <link type="text/css" href="assets/pprtnaa/cssmin/login.css" rel="stylesheet">
  ...
  <?php else : ?>
    ...
    <!-- Theme CSS -->
    <link type="text/css" href="assets/pprtnaa/css/theme.css" rel="stylesheet">

    <!-- Login CSS -->
    <link type="text/css" href="assets/pprtnaa/css/login.css" rel="stylesheet">
  ...
  <?php if (DEMO || USECOMPILEDASSET) : ?>
    ...
    <!-- Login Combined JS -->
    <script src="assets/pprtnaa/jsmin/login.js"></script>
  ...
  <?php else : ?>
    ...
    <!-- Common JS -->
    <script src="assets/pprtnaa/js/common.js"></script>

    <!-- Login JS -->
    <script src="assets/pprtnaa/js/login.js"></script>

  <?php endif; ?>

</head>
<body class="login-page">
<div class="hidden"><?php include('assets/pprtnaa/img/iconmin/membership/membership.svg');?></div>
  ...
  <section class="login-box">
        ...
        <table class="table table-bordered table-striped">
          <tbody>
            <?php foreach (get_users() as $the_user) : ?>
              <?php if (in_array($the_user['email'], array('admin@pabloretana.me', 'cashier@pabloretana.me', 'salesman@pabloretana.me'))) : ?>
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="https://pabloretana.me">Soporte tecnico 50180240</a> </p>
    </div>
  </section>
