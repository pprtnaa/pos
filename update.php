...
if (!function_exists("checkValidationServerConnection")) {
    function checkValidationServerConnection($domain = 'www.pabloretana.me')  
    {
        if($socket =@ fsockopen($domain, 80, $errno, $errstr, 30)) {
            fclose($socket);
            return true;
...
<div class="container">
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="col-sm-8 col-sm-offset-2">  
            ...
            <div class="text-center copyright">&copy; <a href="http://pabloretana.me">pabloretana.me</a>, All right reserved.</div>
        </div>
    </div>
</div>
