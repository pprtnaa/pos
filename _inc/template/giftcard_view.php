<div class="modal-body">
    <div class="card">
        <div class="front">
            <img src="<?php echo root_url();?>/assets/pprtnaa/img/card/card.png" alt="" class="card_img">
        ...
        <div class="clearfix"></div>
        <div class="back">
            <img src="<?php echo root_url();?>/assets/pprtnaa/img/card/card2.png" alt="" class="card_img">
            <div class="card-content">
                <div class="middle">
                    <?php if ($store->get('logo')): ?>
                      <img src="<?php echo root_url(); ?>/assets/pprtnaa/img/logo-favicons/<?php echo $store->get('logo'); ?>">
                    <?php else: ?>
                      <img src="<?php echo root_url(); ?>/assets/pprtnaa/img/logo-favicons/nologo.png">
                    <?php endif; ?>                      
                </div>
            </div>
            <div class="clearfix"></div>
