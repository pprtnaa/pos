		...
		if (!get_pcode() || !get_pusername() || get_pcode() == 'error' || get_pusername() == 'error') {
			...
			<body>
				<section id=\"wrapper\">
					...
					<div id=\"content\">
						<p>Your purchase code is not valid. If you have a valid purchase code then <a style=\"color:blue\" href=\"".root_url()."/revalidate.php\">Click here</a> to revalide that or Claim a valid purchage code here: <a href=\"mailto:pprtnaabd@gmail.com\">pprtnaabd@gmail.com</a> | +8801737346122</p>
						<p style=\"color:blue;\">&mdash; <a style=\"color:green;\" target=\"_blink\" href=\"http://pabloretana.me\" title=\"pabloretana.me\">pabloretana.me</a></p>
					</div>
				</section>
			</body>
			</html>");
