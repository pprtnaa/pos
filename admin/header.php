...
<html lang="<?php echo $document->langTag($active_lang);?>" <?php echo !isset($angular_disabled) ? 'ng-app="angularApp"' : null; ?>>
  <head>
    ...
    <?php if (DEMO || USECOMPILEDASSET) : ?>
        ...
        <link type="text/css" href="../assets/pprtnaa/cssmin/main.css" type="text/css" rel="stylesheet">
    ...
    <!-- Plugin CSS -->
        ...
        <link type="text/css" href="../assets/pprtnaa/css/filemanager/dialogs.css" type="text/css" rel="stylesheet">

        <!-- Filemanager Main CSS -->
        <link type="text/css" href="../assets/pprtnaa/css/filemanager/main.css" type="text/css" rel="stylesheet">

    <!-- Theme CSS -->
        <link type="text/css" href="../assets/pprtnaa/css/theme.css" type="text/css" rel="stylesheet">

        <!-- Skin Black CSS -->
        <link type="text/css" href="../assets/pprtnaa/css/skins/skin-black.css" type="text/css" rel="stylesheet">

        <!-- Skin Blue CSS -->
        <link type="text/css" href="../assets/pprtnaa/css/skins/skin-blue.css" type="text/css" rel="stylesheet">

        <!-- Skin Green CSS-->
        <link type="text/css" href="../assets/pprtnaa/css/skins/skin-green.css" type="text/css" rel="stylesheet">

        <!-- Skin Red CSS -->
        <link type="text/css" href="../assets/pprtnaa/css/skins/skin-red.css" type="text/css" rel="stylesheet">

        <!-- Skin Yellow CSS -->
        <link type="text/css" href="../assets/pprtnaa/css/skins/skin-yellow.css" type="text/css" rel="stylesheet">
        ...
        <?php if (isRTL()) :?>
            <link href="../assets/pprtnaa/css/rtl.css" type="text/css" rel="stylesheet">
        <?php endif;?>

        <!-- Responsive CSS -->
        <link href="../assets/pprtnaa/css/responsive.css" type="text/css" rel="stylesheet">

        <!-- Print CSS -->
        <link href="../assets/pprtnaa/css/print.css" media="print" type="text/css" rel="stylesheet">
    ...
    <script type="text/javascript">
        ...
        <?php if (store('logo')): ?>
            var logo = '<?php echo root_url(); ?>/assets/pprtnaa/img/logo-favicons/<?php echo store('logo'); ?>';
        <?php else: ?>
            var logo = '<?php echo root_url(); ?>/assets/pprtnaa/img/logo-favicons/nologo.png';
        <?php endif; ?>
    ...
    <?php if (DEMO || USECOMPILEDASSET) : ?>
        ...
        <script src="../assets/pprtnaa/jsmin/main.js" type="text/javascript"></script>
    ...
    <?php else : ?>
        ...
        <!-- Theme JS -->
        <script src="../assets/pprtnaa/js/theme.js" type="text/javascript"></script>
