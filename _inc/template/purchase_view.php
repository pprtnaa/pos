...
<div id="quotataion-view">
	...
	<?php if ($store->get('logo')): ?>
	  <img src="<?php echo root_url(); ?>/assets/pprtnaa/img/logo-favicons/<?php echo $store->get('logo'); ?>" width="auto" height="60">
	<?php else: ?>
	  <img src="<?php echo root_url(); ?>/assets/pprtnaa/img/logo-favicons/nologo.png" width="auto" height="60">
	<?php endif; ?>
	</div>
