...
// Add Script
$document->addScript('../assets/pprtnaa/angular/modals/PurchaseLogViewModal.js');
$document->addScript('../assets/pprtnaa/angular/controllers/PurchaseLogController.js');
