...
// Add ScriptS
$document->addScript('../assets/pprtnaa/angular/modals/InstallmentPaymentModal.js');
$document->addScript('../assets/pprtnaa/angular/modals/InstallmentViewModal.js');
$document->addScript('../assets/pprtnaa/angular/modals/CustomerSubstractBalanceModal.js');
$document->addScript('../assets/pprtnaa/angular/modals/CustomerAddBalanceModal.js');
$document->addScript('../assets/pprtnaa/angular/controllers/CustomerController.js');
$document->addScript('../assets/pprtnaa/angular/controllers/CustomerProfileController.js');
