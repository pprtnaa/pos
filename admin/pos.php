...
<head>
    ...
    <?php if (store('favicon')): ?>
		<link rel="shortcut icon" href="../assets/pprtnaa/img/logo-favicons/<?php echo store('favicon'); ?>">
	<?php else: ?>
		<link rel="shortcut icon" href="../assets/pprtnaa/img/logo-favicons/nofavicon.png">
	<?php endif; ?>
	...
	<?php if (DEMO || USECOMPILEDASSET) : ?>
		...
		<link href="../assets/pprtnaa/cssmin/pos.css" type="text/css" rel="stylesheet">
	...
	<?php else : ?>
		...
		<!-- Filemanager CSS -->
	    <link href="../assets/pprtnaa/css/filemanager/dialogs.css" type="text/css" rel="stylesheet">
	    <link href="../assets/pprtnaa/css/filemanager/main.css" type="text/css" rel="stylesheet">

	    <!-- Theme CSS -->
	    <link href="../assets/pprtnaa/css/theme.css" type="text/css" rel="stylesheet">

	    <!-- Skin Black CSS -->
	    <link href="../assets/pprtnaa/css/skins/skin-black.css" type="text/css" rel="stylesheet">

	    <!-- Skin Blue CSS -->
	    <link href="../assets/pprtnaa/css/skins/skin-blue.css" type="text/css" rel="stylesheet">

	    <!-- Skin Green CSS -->
	    <link href="../assets/pprtnaa/css/skins/skin-green.css" type="text/css" rel="stylesheet">

	    <!-- Skin Red CSS -->
	    <link href="../assets/pprtnaa/css/skins/skin-red.css" type="text/css" rel="stylesheet">

	    <!-- Skin Yellow CSS -->
	    <link href="../assets/pprtnaa/css/skins/skin-yellow.css" type="text/css" rel="stylesheet">

	    <!-- Main CSS -->
	    <link href="../assets/pprtnaa/css/main.css" type="text/css" rel="stylesheet">

		<!-- Skeleton CSS -->
		<link href="../assets/pprtnaa/css/pos/skeleton.css" rel="stylesheet" type="text/css">

		<!-- Main CSS -->
		<link href="../assets/pprtnaa/css/pos/pos.css" rel="stylesheet" type="text/css">

		<!-- Responsive CSS -->
		<link href="../assets/pprtnaa/css/pos/responsive.css" rel="stylesheet" type="text/css">
	...
	<style type="text/css">
		body::after { 
			content: ""; background: url(../assets/pprtnaa/img/pos/patterns/<?php echo $user->getPreference('pos_pattern') ? $user->getPreference('pos_pattern') : 'armysuit.jpg'; ?>) repeat repeat;opacity: 0.4;filter: alpha(opacity=40);top: 0;left: 0;bottom: 0;right: 0;position: absolute;z-index: -1;
		}
...
<div class="hidden"><?php include('../assets/pprtnaa/img/iconmin/icon.svg');?></div>
<?php include('../_inc/template/pos_skeleton.php'); ?>
						...
						<div class="contents">
							...
							<div id="item-list">
								...
								<div ng-show="showLoader" class="ajax-loader">
									<img src="../assets/pprtnaa/img/loading2.gif">
								</div>
	...
	<?php if (DEMO || USECOMPILEDASSET) : ?>
		...
		<script src="../assets/pprtnaa/jsmin/pos.js" type="text/javascript"></script>
	...
	<?php else : ?>
		...
		<!-- Angular JS -->
	    <script src="../assets/pprtnaa/angularmin/angular.js" type="text/javascript"></script> 

	    <!-- AngularApp JS -->
	    <script src="../assets/pprtnaa/angular/angularApp.js" type="text/javascript"></script>

	    <!-- Filemanager JS -->
	    <script src="../assets/pprtnaa/angularmin/filemanager.js" type="text/javascript"></script>

	    <!-- Angular JS Modal -->
		<script src="../assets/pprtnaa/angularmin/modal.js" type="text/javascript"></script>
		...
		<!-- IE JS -->
		<script src="../assets/pprtnaa/js/ie.js" type="text/javascript"></script>

		<!-- Common JS -->
		<script src="../assets/pprtnaa/js/common.js" type="text/javascript"></script>

		<!-- Main JS -->
		<script src="../assets/pprtnaa/js/main.js" type="text/javascript"></script>

		<!-- POS Main JS -->
		<script src="../assets/pprtnaa/js/pos/pos.js" type="text/javascript"></script>

<?php endif; ?>

<script src="../assets/pprtnaa/angular/modals/AddInvoiceNoteModal.js" type="text/javascript"></script>
<script src="../assets/pprtnaa/angular/modals/AddCustomerMobileNumberModal.js" type="text/javascript"></script>
<script src="../assets/pprtnaa/angular/modals/HoldingOrderModal.js" type="text/javascript"></script>
<script src="../assets/pprtnaa/angular/modals/HoldingOrderDetailsModal.js" type="text/javascript"></script>
<script src="../assets/pprtnaa/angular/controllers/PosController.js" type="text/javascript"></script>
<noscript>
